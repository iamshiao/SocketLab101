        ...
        public static void StartClient()
        {
            ...
            try {
                ...
                try {
                    ...
                    byte[] msg = Encoding.ASCII.GetBytes("This is a Call<EOF>");
                    ...
                    // Continuously Recv will not effect. The first all will Recv all
                    //bytesRec = sender.Receive(bytes); 
                    //Console.WriteLine($"Recv {Encoding.ASCII.GetString(bytes, 0, bytesRec)}");

                    // Encode the data string into a byte array.
                    msg = Encoding.ASCII.GetBytes("This is Call2");
                    // Send the data through the socket.
